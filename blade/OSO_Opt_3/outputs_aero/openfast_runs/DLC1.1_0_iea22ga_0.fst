...
---------------------- INPUT FILES ---------------------------------------------
"DLC1.1_0_iea22ga_0_ElastoDyn.dat" EDFile      - Name of file containing ElastoDyn input parameters (quoted string)
"DLC1.1_0_iea22ga_0_BeamDyn.dat" BDBldFile(1) - Name of file containing BeamDyn input parameters for blade 1 (quoted string)
"DLC1.1_0_iea22ga_0_BeamDyn.dat" BDBldFile(2) - Name of file containing BeamDyn input parameters for blade 2 (quoted string)
"DLC1.1_0_iea22ga_0_BeamDyn.dat" BDBldFile(3) - Name of file containing BeamDyn input parameters for blade 3 (quoted string)
"DLC1.1_0_iea22ga_0_InflowWind.dat" InflowFile  - Name of file containing inflow wind input parameters (quoted string)
"DLC1.1_0_iea22ga_0_AeroDyn.dat" AeroFile    - Name of file containing aerodynamic input parameters (quoted string)
"DLC1.1_0_iea22ga_0_ServoDyn.dat" ServoFile   - Name of file containing control and electrical-drive input parameters (quoted string)
