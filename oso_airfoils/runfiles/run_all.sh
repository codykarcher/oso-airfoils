...
#   - qfoil cases : 188 MPI processes

cd "$(dirname "${BASH_SOURCE[0]}")"

# --- neuralfoil ---
mpirun -n 96  python -m oso_airfoils.optimization.runner t15_neuralfoil.yaml
...
# --- xfoil ---
mpirun -n 188 python -m oso_airfoils.optimization.runner t15_xfoil.yaml
...
# --- qfoil ---
mpirun -n 188 python -m oso_airfoils.optimization.runner t15_qfoil.yaml
mpirun -n 188 python -m oso_airfoils.optimization.runner t18_qfoil.yaml
mpirun -n 188 python -m oso_airfoils.optimization.runner t21_qfoil.yaml
mpirun -n 188 python -m oso_airfoils.optimization.runner t24_qfoil.yaml
mpirun -n 188 python -m oso_airfoils.optimization.runner t27_qfoil.yaml
mpirun -n 188 python -m oso_airfoils.optimization.runner t30_qfoil.yaml
mpirun -n 188 python -m oso_airfoils.optimization.runner t33_qfoil.yaml
mpirun -n 188 python -m oso_airfoils.optimization.runner t36_qfoil.yaml
